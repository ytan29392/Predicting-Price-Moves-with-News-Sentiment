...
def merge_sentiment_and_returns(sentiment_df, returns_df):
    ...
    # Merge daily sentiment and stock returns by date and stock.
    ...
    merged_df = pd.merge(
        sentiment_df, returns_df, how='inner', 
        left_on=['Date', 'Stock'], right_on=['Date']
    )
...
def calculate_correlation(merged_df, save_path='reports/correlation_plot.png'):
    ...
    # Calculate and plot correlation between sentiment and returns.
